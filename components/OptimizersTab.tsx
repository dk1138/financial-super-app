...
import TFSARoomCalculator from './optimizers/TFSARoomCalculator';
...
const OPTIMIZER_TOOLS = [
  ...
  { id: 'tfsa-room', label: 'TFSA Room Calculator', icon: 'bi-calculator-fill', desc: 'Calculate accumulated deposit room' },
...
export default function OptimizersTab() {
  ...
  const renderActiveTool = () => {
    switch (activeTool) {
      ...
      case 'tfsa-room': return <TFSARoomCalculator />;
