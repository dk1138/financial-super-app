...
export default function RiskTab() {
  ...
  const runMonteCarlo = () => {
    ...
    // Give browser time to paint the loading spinner before locking thread
    setTimeout(() => {
      try {
    ...
    <div className="p-4 p-md-5">
      <div className="row g-5">
        ...
        <div className="col-12 col-xl-4">
          <h5 className="text-muted small text-uppercase fw-bold ls-1 mb-4 pb-2 border-bottom border-secondary"><i className="bi bi-gear-wide-connected me-2 text-danger"></i>Simulation Settings</h5>
          <div className="card p-4 surface-card bg-black bg-opacity-10 border-secondary rounded-4 shadow-sm mb-4">
            ...
            <button className="btn btn-danger w-100 fw-bold py-2 mt-4 shadow" onClick={runMonteCarlo} disabled={isCalculating}>
          ...
          <div className="card p-4 text-center surface-card bg-black bg-opacity-10 border-secondary rounded-4 shadow-sm align-items-center">
        ...
        <div className="col-12 col-xl-8">
          ...
          <div className="rp-card p-4 surface-card bg-black bg-opacity-10 border border-secondary rounded-4 h-100 d-flex flex-column shadow-sm">
             {chartComponent}
          </div>
        </div>
