...
export const FINANCIAL_CONSTANTS = {
    ...
    FED_CAREGIVER_AMOUNT: 8500,
    FED_MEDICAL_EXPENSE_THRESHOLD_MAX: 2900,
    FED_MEDICAL_EXPENSE_THRESHOLD_RATE: 0.03,
    FED_CHARITABLE_DONATION_THRESHOLD: 200,
    FED_CHARITABLE_DONATION_RATE_1: 0.15,
    FED_CHARITABLE_DONATION_RATE_2: 0.29,
    FED_CHARITABLE_DONATION_RATE_3: 0.33,
    ...
    TAX_DATA: {
        ...
        ON: { brackets: [53891, 107785, 150000, 220000], rates: [0.0505, 0.0915, 0.1116, 0.1216, 0.1316], surtax: { t1: 5818, r1: 0.20, t2: 7446, r2: 0.36 } },
