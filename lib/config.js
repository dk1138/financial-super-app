...
export const FINANCIAL_CONSTANTS = {
    ...
    OAS_CLAWBACK_THRESHOLD: 95323, // Official threshold for OAS recovery tax
    ...
    // EI & Maternity Leave Rules (Estimates)
    MAX_EI_WEEKLY_BENEFIT: 720,    // Projected max weekly EI payment
    ...
    FED_AGE_AMOUNT: 9028,
    FED_AGE_PHASE_START: 45522,
    FED_EMPLOYMENT_AMOUNT: 1501,
    FED_PENSION_AMOUNT: 2000,

    // Additional Non-Refundable Personal Tax Credits
    ...
    PROV_HOME_BUYERS_AMOUNT: {
        'QC': 10000, 'SK': 10000 // Only QC and SK have explicit T1 Non-Refundable Credits for this. Others use Land Transfer rebates.
    },
    ...
    // Provincial Medical Expense Threshold Maximums (Indexed estimates)
    ...
    // Provincial Caregiver Amounts (Indexed estimates)
    ...
    // Provincial Basic Personal Amounts (Indexed estimates)
    PROV_BPA: {
        'ON': 12989, 'BC': 13216, 'AB': 22769, 'QC': 18952, 'MB': 15780,
        'SK': 20381, 'NS': 11932, 'NB': 13664, 'NL': 11188, 'PE': 15000
    },

    // Provincial Age Amounts (Based on CRA Line 30100)
    PROV_AGE_AMOUNT: { 
        'ON': 6223, 'BC': 5799, 'AB': 6221, 'MB': 3728, 'QC': 3906,
        'SK': 5785, 'NS': 5734, 'NB': 6037, 'NL': 7064, 'PE': 6510,
        'YT': 9028, 'NT': 8727, 'NU': 12303
    },

    // Provincial Age Phase-Out Starts (Based on CRA Line 30100)
    PROV_AGE_PHASE_START: { 
        'ON': 46330, 'BC': 43169, 'AB': 46308, 'MB': 27749, 'QC': 42825,
        'SK': 43066, 'NS': 30828, 'NB': 44945, 'NL': 38712, 'PE': 36600,
        'YT': 45522, 'NT': 45522, 'NU': 45522
    },

    // Provincial Pension Credit Amounts
    PROV_PENSION_AMOUNT: { 'ON': 1796 },

    // Provincial Disability Credit Amounts (Indexed estimates)
    ...
    // ---------------------------------------------------------
    ON_SENIORS_TRANSIT_MAX_EXPENSE: 3000,
    ON_SENIORS_TRANSIT_RATE: 0.15,
    ON_SENIORS_TRANSIT_ELIGIBLE_AGE: 65,
    ...
    TAX_DATA: {
        ...
        BC: { brackets: [50363, 100728, 115648, 140430, 190405, 265545], rates: [0.0506, 0.077, 0.105, 0.1229, 0.147, 0.168, 0.205] },
        AB: { brackets: [61200, 154259, 185111, 246813, 370220], rates: [0.08, 0.10, 0.12, 0.13, 0.14, 0.15] },
        SK: { brackets: [54532, 155805], rates: [0.105, 0.125, 0.145] },
        ...
        QC: { brackets: [54345, 108680, 132245], rates: [0.14, 0.19, 0.24, 0.2575], abatement: 0.165 },
        NB: { brackets: [52333, 104666, 193861], rates: [0.094, 0.14, 0.16, 0.195] },
        NS: { brackets: [30995, 61991, 97417, 157124], rates: [0.0879, 0.1495, 0.1667, 0.175, 0.21] },
        PE: { brackets: [33928, 65820, 106890, 142250], rates: [0.095, 0.1347, 0.166, 0.1762, 0.19] },
        NL: { brackets: [44678, 89354, 159528, 223340, 285319, 570638, 1141275], rates: [0.087, 0.145, 0.158, 0.178, 0.198, 0.208, 0.213, 0.218] },
        YT: { brackets: [58523, 117045, 181440, 500000], rates: [0.064, 0.09, 0.109, 0.128, 0.15] },
        NT: { brackets: [53003, 106009, 172346], rates: [0.059, 0.086, 0.122, 0.1405] },
        NU: { brackets: [55801, 111602, 181439], rates: [0.04, 0.07, 0.09, 0.115] }
    },
