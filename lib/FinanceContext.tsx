...
export const emptyData = {
  ...
  inputs: {
    ...
    fully_optimize_tax: false, oas_clawback_optimize: false, rrsp_meltdown_enabled: false,
    skip_first_tfsa_p1: false, skip_first_rrsp_p1: false,
    skip_first_tfsa_p2: false, skip_first_rrsp_p2: false,
...
export const migrateLegacyData = (parsedData: any, baseData: any) => {
    ...
    if (parsedData.inputs) {
        Object.keys(parsedData.inputs).forEach(k => {
            ...
            // Clean old comma-separated numbers (e.g. "195,120" -> 195120)
...
export function FinanceProvider({ children }: { children: ReactNode }) {
  ...
  const loadData = (newPlanData: any) => setData(migrateLegacyData(newPlanData, emptyData));
