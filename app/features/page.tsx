      ...
      <main className="pt-48 pb-24">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mb-24">
            <h1 className="text-5xl md:text-7xl font-black text-white mb-6 tracking-tight">Designed for the <span className="text-blue-500">Sophisticated</span> Canadian.</h1>
          ...
          <div className="mt-32 p-12 rounded-[3rem] bg-gradient-to-br from-blue-600 to-blue-800 text-center">
